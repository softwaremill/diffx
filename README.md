...
```scala
"com.softwaremill.diffx" %% "diffx-scalatest" % "0.3.25" % Test
```
...
```scala
"com.softwaremill.diffx" %% "diffx-specs2" % "0.3.25" % Test
```
...
```scala
"com.softwaremill.diffx" %% "diffx-utest" % "0.3.25" % Test
```
...
```scala
"com.softwaremill.diffx" %% "diffx-tagging" % "0.3.25"
```
