...
```scala
"com.softwaremill.diffx" %% "diffx-scalatest" % "0.3.10"
```
...
```scala
"com.softwaremill.diffx" %% "diffx-specs2" % "0.3.10"
```
...
```scala
"com.softwaremill.diffx" %% "diffx-core" % "0.3.10"
```
...
```scala
"com.softwaremill.diffx" %% "diffx-tagging" % "0.3.10"
```
