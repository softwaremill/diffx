...
```scala
"com.softwaremill.diffx" %% "diffx-core" % "0.5.0+13-3ec13ae6+20210621-1024-SNAPSHOT"
```
...
- [eu.timepit.refined](https://github.com/fthomas/refined)
    ```scala
    "com.softwaremill.diffx" %% "diffx-refined" % "0.5.0+13-3ec13ae6+20210621-1024-SNAPSHOT"    
    ```
    `com.softwaremill.diffx.refined.RefinedSupport`
- [org.typelevel.cats](https://github.com/typelevel/cats)
    ```scala
    "com.softwaremill.diffx" %% "diffx-cats" % "0.5.0+13-3ec13ae6+20210621-1024-SNAPSHOT"    
    ```
