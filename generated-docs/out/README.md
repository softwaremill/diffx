...
```scala
"com.softwaremill.diffx" %% "diffx-core" % "0.5.0+22-d71a0664+20210622-1047-SNAPSHOT"
```
...
- [eu.timepit.refined](https://github.com/fthomas/refined)
    ```scala
    "com.softwaremill.diffx" %% "diffx-refined" % "0.5.0+22-d71a0664+20210622-1047-SNAPSHOT"    
    ```
    `com.softwaremill.diffx.refined.RefinedSupport`
- [org.typelevel.cats](https://github.com/typelevel/cats)
    ```scala
    "com.softwaremill.diffx" %% "diffx-cats" % "0.5.0+22-d71a0664+20210622-1047-SNAPSHOT"    
    ```
